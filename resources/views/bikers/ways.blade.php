...
<html lang="en">
  ...
  <body class="app-bg">
    ...
    <script>
      ...
      nav.innerHTML =
        '<a class="sidebar-row active-row" href="./ways.html"><strong>Ways</strong><span>Assigned deliveries</span></a><a class="sidebar-row" href="./history.html"><strong>History</strong><span>My records</span></a>';
