    ...
    <main class="workspace-body">
      ...
      <form class="ui-card-white history-filter-card" method="GET" action="{{ route('admin.history') }}">
        ...
        <div style="display:flex; gap:12px; flex-wrap:wrap; align-items:center;">
          ...
          <a class="ui-btn btn-navy-blue history-save" href="{{ route('admin.history') }}" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center;">
            All Clear
          </a>
