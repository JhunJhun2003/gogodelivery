  ...
  document
    ...
    .forEach((row) =>
      row.classList.toggle(
        "active-row",
        row.getAttribute("href") === "./bikers.html",
      ),
    );
</script>
